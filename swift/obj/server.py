...
class ObjectController(BaseStorageServer):
    ...
    def __call__(self, env, start_response):
        ...
        if not check_utf8(req.path_info):
            ...
            try:
                ...
                if req.method not in self.allowed_methods:
                    ...
                    res = getattr(self, req.method)(req)        #goes to PUT of object-server
        ...
        '''
        added by me:
        YOu know what?  I dont want the threads to wait! Fuck em, whats gonna happen?'''
        if req.method in ('PUT', 'DELETE'):                         #we should make it sleep so that it immediately doesnt jump to next if-else clause and return resp before PUT completes alll the tasks.
